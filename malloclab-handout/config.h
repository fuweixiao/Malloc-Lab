 ...
 */
#define AVG_LIBC_THRUPUT      11628E3  /* 600 Kops/sec */
 ...
 *
 *
 * To compute it you can use the 'ulimit -a' build-in command of bash.
 * However, it seems to be reporting 'unlimited' thus the default 20MB
